import sys  
sys.path.insert(0, '/data/ssd-caffe/cp_caffe/python')
import caffe  
import numpy as np  
...
weights = '/data/github_repos/darknet/ncs/yolov3-tiny-ncs-without-last-maxpool_30000.weights'
prototxt = '/data/github_repos/darknet/ncs/yolov3-tiny-ncs-without-last-maxpool.prototxt'
caffemodel = 'Jenerated_nolastpooling_cars.caffemodel'
